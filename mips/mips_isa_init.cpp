...
ac_dec_instr mips_parms::mips_isa::instructions[mips_parms::AC_DEC_INSTR_NUMBER] = {
  ...
  {"mult", 4, "mult", "mult %reg, %reg", "Type_R", 38, 4, 1, 1, &(mips_parms::mips_isa::dec_list[56]), 0, &(mips_parms::mips_isa::instructions[38])},
  {"multu", 4, "multu", "multu %reg, %reg", "Type_R", 39, 4, 1, 1, &(mips_parms::mips_isa::dec_list[58]), 0, &(mips_parms::mips_isa::instructions[39])},
  {"div", 4, "div", "div %reg, %reg", "Type_R", 40, 30, 1, 1, &(mips_parms::mips_isa::dec_list[60]), 0, &(mips_parms::mips_isa::instructions[40])},
  {"divu", 4, "divu", "divu %reg, %reg", "Type_R", 41, 30, 1, 1, &(mips_parms::mips_isa::dec_list[62]), 0, &(mips_parms::mips_isa::instructions[41])},
